...
#define EQ_FILE_NAME_0		SDFILE_RES_ROOT_PATH"eq_cfg_hw.bin"
#define EQ_FILE_NAME_1		SDFILE_RES_ROOT_PATH"eq_cfg_hw1.bin"
#define EQ_FILE_NAME_2		SDFILE_RES_ROOT_PATH"eq_cfg_hw2.bin"
#define EQ_FILE_NAME_3		SDFILE_RES_ROOT_PATH"eq_cfg_hw3.bin"
#define EQ_FILE_NAME_4		SDFILE_RES_ROOT_PATH"eq_cfg_hw4.bin"
#define EQ_FILE_NUM			5
static const char *const eq_file_num[] = {
	EQ_FILE_NAME_0,
	EQ_FILE_NAME_1,
	EQ_FILE_NAME_2,
	EQ_FILE_NAME_3,
...
void user_eq_file_change(u8 mode)
{
	s32 ret = 0;

	r_printf("%s , eq_mode = %d\n", __func__, mode);
	if(user_eq_file_cfg){
		if(mode>=EQ_FILE_NUM){
			mode = 0;
		}

		ret = eq_file_get_cfg(user_eq_file_cfg, eq_file_num[mode]);
		printf("eq_file_name = %s, ret = %x\n", eq_file_num[mode], ret);
	}else{
		printf("eq file not find, please check...\n");
	}
}
#endif
