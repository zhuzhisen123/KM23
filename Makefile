...
.PHONY: all clean ac701n adapter_tx_2t1 clean_ac701n clean_adapter_tx_2t1

all: ac701n adapter_tx_2t1
	@echo +ALL DONE

clean: clean_ac701n clean_adapter_tx_2t1
	@echo +CLEAN DONE
